...
- **СЧЁТ «ворот» — pluralia tantum, НЕ считай напрямую (owner 2026-07-20).** «ворота» — существительное pluralia
  tantum (всегда мн. ч.), поэтому счёт требует собирательного числительного: «двое/трое ворот». Это грамматически
  верно, но в техпрозе звучит архаично (owner поймал «двое приёмочных ворот» в Уроке 5). → когда нужно СОСЧИТАТЬ,
  перефразируй счётным синонимом для этого места («две приёмочные проверки», «два проверочных механизма») ИЛИ
  переставь так, чтобы не считать («сами ворота…»). Термин «ворота» остаётся для несчётного концепта (Sense B).
  SK-параллель проблемы НЕТ: «brána» — обычное сущ., «dve brány» считается штатно.
