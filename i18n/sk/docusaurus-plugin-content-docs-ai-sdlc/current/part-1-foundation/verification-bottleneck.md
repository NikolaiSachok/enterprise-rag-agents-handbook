...
Dve výhrady k rozsahu. Išlo o učenie sa **neznámej** knižnice, nie o ustálenú prácu na známom kóde. A je to zistenie proti vlastnému záujmu — autor z Anthropicu poukazuje na hranicu vlastnej AI, čo mu treba pripísať k dobru. Či sa „dlh na porozumení“ kumuluje počas celej kariéry, je zatiaľ `UNKNOWN` (neznáme).
...
OpenAI stiahlo z odporúčania **SWE-bench Verified** (23. 2. 2026): **aspoň 59,4 %** z auditovaných najťažších úloh malo testy, ktoré **odmietajú aj funkčne správne riešenie**, a skóre podľa OpenAI už odráža najmä to, koľko z benchmarku model videl počas tréningu. O päť mesiacov nato OpenAI **odvolalo aj vlastné odporúčanie** náhrady, SWE-bench Pro (8. 7. 2026), s odhadom, že asi **30 %** jej úloh je pokazených. `MEASURED`. Výsledok: v čase písania neexistuje žiaden odborom uznaný špičkový benchmark na kódovanie.
