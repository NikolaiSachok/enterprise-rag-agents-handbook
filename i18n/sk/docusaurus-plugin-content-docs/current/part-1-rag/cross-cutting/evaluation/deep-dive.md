...
**[Nové pojmy](../../../glossary.md)**: context precision, context recall, faithfulness, answer relevance, reference-free vs reference-based, LLM-judge calibration, position bias, verbosity bias, self-preference / self-enhancement bias, pointwise vs pairwise, inter-annotator agreement (Cohen's kappa, Fleiss' kappa), active sampling / active learning.
