...
Pozri aj: [záverečnú stránku o skutočných agentoch](../real-agents/) — MCP naživo na Claude, OpenAI a Gemini; [multiagentové systémy](../multi-agent/index.md) pre os agent↔agent, ktorú MCP necháva otvorenú; a [orchestračné frameworky](../orchestration-frameworks/index.md), ktoré tieto napojenia zabalia do knižnice.
