...
- Dve klientske schopnosti obracajú spojenie: sampling požičia serveru model klienta na generovanie textu, elicitation mu dovolí vyžiadať si od používateľa chýbajúci údaj. Obe sú plochy súhlasu — sampling vyžaduje podľa špecifikácie povinné schválenie používateľom — a obe k 25. novembru 2025 stále rástli. Tichšia tretia je roots: klient serveru ohraničí dosah na súborový systém a URI, teda najnižšie oprávnenia na úrovni protokolu.
