...
Большинство опубликованных схем — включая практические материалы, на которые опирается этот курс, — изображают конвейер, заканчивающийся на «проде» и не возвращающий обратную связь. Именно эту рамку курс и исправляет. Подавай это как исправление, а не как повод для хвастовства: главный структурный пробел в современных материалах состоит в том, что цикл обучения замыкается на внутреннем QA, а не на эксплуатации живой системы. В хорошо организованном цикле неудачное изменение обнаруживает и откатывает *сама система* — ещё до того, как пользователю придётся пожаловаться.
