...
[Evaluation](../cross-cutting/evaluation.md)), что узкое место — действительно сильная общая или
...
[Evaluation](../cross-cutting/evaluation.md)), потому что опубликованные мультиязычные рейтинги усредняют по
...
**Новые термины** → [Глоссарий](../../glossary.md): document parsing / layout-aware extraction, OCR, late chunking, embedding fine-tuning, Matryoshka Representation Learning (MRL), contextual retrieval, multilingual embeddings, dimensionality.
