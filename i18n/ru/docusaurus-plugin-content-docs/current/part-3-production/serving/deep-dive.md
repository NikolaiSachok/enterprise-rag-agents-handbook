...
**[Новые термины](../../glossary.md)**: ASGI-воркеры, uvloop, пул потоков, backpressure, load shedding, контроль допуска, закон Литтла, планирование на уровне итерации, prefill / decode, chunked prefill, кэширование префикса, квантизация, квантизация KV-кэша, тензорный параллелизм, конвейерный параллелизм, параллелизм данных, MIG (Multi-Instance GPU), нарезка GPU по времени, KEDA, KServe, serverless-GPU.
