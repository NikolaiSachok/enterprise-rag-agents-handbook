...
Four times already we've hit the wall of "you measure that with metrics" — at chunking, retrieval,
...
- **LLM-as-judge** scores free-form text against a rubric; mind the biases, validate against humans.
