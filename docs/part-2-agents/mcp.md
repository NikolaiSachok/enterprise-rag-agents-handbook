...
Под неё складывается свой стандарт — **A2A (Agent-to-Agent)**, предложенный Google и переданный затем под
...
про [инструменты](./tool-use.md). Научились [держать цикл направленным на цель и в
