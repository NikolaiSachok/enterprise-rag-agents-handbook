...
а не всё его промежуточное рассуждение и сырой вывод инструментов. Именно это позволяет мультиагентной
...
независимо порождают решения, а лучшее из них выбирают. Идея **дебатов (debate)** та же, что у слепого рецензирования:
...
**Распространение ошибки.** Промах одного агента отравляет всё, что стоит ниже по потоку. Общей опоры
на истину нет, поэтому неверный промежуточный результат следующий агент принимает за факт и строит на нём
своё.
...
**Отлаживать и мерять — сложнее.** Траектория теперь размазана по нескольким агентам, и наблюдаемость обязана
**сшивать** куски в одну связную цепочку — иначе сбой не найти. Это заостряет тезис из планирования: трейсить
надо всю траекторию целиком, а в мультиагентной системе она ещё и разорвана между исполнителями.
...
Системы глубокого исследования устроены так же. Ведущий агент порождает несколько поисковиков, они работают
