...
- **Script and tokenization.** Languages with rich morphology or non-Latin scripts — Russian among them — can tokenize inefficiently, burning context length and dragging quality down.
