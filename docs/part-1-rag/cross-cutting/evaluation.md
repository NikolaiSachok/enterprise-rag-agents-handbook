...
демо, и именно про это чаще всего копают на собеседованиях.

## Главный принцип: retrieval и generation оценивают отдельно

Декомпозиция провалов из первого урока здесь становится рабочим инструментом. Две стадии ломаются по-разному и
