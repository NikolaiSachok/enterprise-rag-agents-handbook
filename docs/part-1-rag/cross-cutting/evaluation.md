...
У судьи есть предвзятость, и о ней надо знать: **position bias** (предпочитает первый из двух ответов),
...
- **LLM-as-judge** оценивает свободный текст по рубрике; помни про предвзятость, валидируй против людей.
