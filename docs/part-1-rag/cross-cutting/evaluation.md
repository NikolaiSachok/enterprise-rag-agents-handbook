...
правила: давать судье чёткие критерии оценки и сверять его вердикты с человеческими, прежде чем им доверять.
...
- **LLM-as-judge** оценивает свободный текст по заданным критериям; помни про предвзятость, сверяй с людьми.
