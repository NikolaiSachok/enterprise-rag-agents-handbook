...
Часть II закончилась протоколами: MCP соединил агента с инструментами, и система наконец собралась в единое
...
Экосистема на сегодня выглядит так: **vLLM** — де-факто стандарт открытого GPU-сервинга. **SGLang** —
второй крупный открытый GPU-сервер. **Ollama** — удобная локальная вещь для разработки и экспериментов,
но в прод её не берут. Hugging Face TGI, который ты ещё встретишь в статьях, — уже история: в декабре 2025-го
