...
Сквозные уроки Части I заканчивались одной и той же оговоркой в скобках: готовые инструменты — LangSmith,
...
Границы категорий при этом проходят прямо внутри продуктов. Платформы наблюдаемости — LangSmith, Langfuse,
Phoenix — несут с собой и eval-функции: датасеты, судей. Причина не в аппетитах поставщиков, а в устройстве самой
...
Второй вид — **модели-классификаторы безопасности** (safety classifier): Llama Guard от Meta и Granite
...
- Ограничители: фреймворки (Guardrails AI, NeMo Guardrails) оркеструют, классификаторы безопасности
  (Llama Guard, Granite Guardian) судят, платформенные сервисы снимают эксплуатацию с тебя — и всё это
